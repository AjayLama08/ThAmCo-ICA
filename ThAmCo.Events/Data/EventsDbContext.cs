    ...
    public class EventsDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Event>().HasData(
                new Event { EventId = 1, EventTypeId = "WED", Title = "John and Jane's Wedding", DateAndTime = new DateTime(2022, 6, 30) },
                new Event { EventId = 2, EventTypeId = "CON", Title = "Tech Innovations 2022", DateAndTime = new DateTime(2022, 7, 15) },
                new Event { EventId = 3, EventTypeId = "PTY", Title = "Alice's Birthday Party", DateAndTime = new DateTime(2022, 8, 12) },
                new Event { EventId = 4, EventTypeId = "WED", Title = "Mike and Emma's Wedding", DateAndTime = new DateTime(2023, 5, 20) },
                new Event { EventId = 5, EventTypeId = "CON", Title = "Digital Marketing Summit", DateAndTime = new DateTime(2023, 10, 8) },
                new Event { EventId = 6, EventTypeId = "PTY", Title = "Bob's Surprise Birthday Party", DateAndTime = new DateTime(2023, 9, 5) },
                new Event { EventId = 7, EventTypeId = "WED", Title = "Sophie and Adam's Wedding", DateAndTime = new DateTime(2024, 1, 13) },
                new Event { EventId = 8, EventTypeId = "CON", Title = "AI and Future Technologies", DateAndTime = new DateTime(2024, 3, 5) },
                new Event { EventId = 9, EventTypeId = "PTY", Title = "Frank's 50th Birthday Party", DateAndTime = new DateTime(2024, 6, 17) },
                new Event { EventId = 10, EventTypeId = "CON", Title = "Business Leadership Forum", DateAndTime = new DateTime(2024, 7, 22) 
                });
